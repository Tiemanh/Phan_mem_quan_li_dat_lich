...
<body>
    ...
    <form class="login-container">
        ...
        <div class="form-group">
            ...
            <input name="password" class="form-control" id="password" placeholder="Nhập password ..."
                type="password" />
        </div>
        <div class="form-group mt-3">
            <label for="check-password"> Xác nhận mật khẩu : </label>
            <input name="check-password" class="form-control" id="check-password" placeholder="Nhập mật khẩu"
                type="password" />
        </div>

        <a href="{{ route('account.login') }}" class="btn mt-4" style="background-color: 92D7EE">Xác nhận</a>
    </form>
